...
├── .superpowers/              ← generated by superpowers tools — do not edit, gitignored
└── package.json
...
3. Create `experiments/[slug]/meta.ts` with experiment metadata
4. Create `experiments/[slug]/index.tsx` with skeleton
5. Create `app/experiments/[slug]/page.tsx` importing the component
6. Test locally with `npm run dev`
7. Push → Vercel deploys automatically
