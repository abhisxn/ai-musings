...
const LIVE_URL = 'https://www.guttergeneration.com'
const REPO_URL = 'https://github.com/abhisxn/fun-satire'

export default function GutterGenerationExperiment() {
  return (
    <div className="flex items-center justify-center h-full w-full bg-bg px-6">
      <div className="flex flex-col items-center gap-6 text-center max-w-md">
        <p className="t-caption text-fg/50 uppercase tracking-wide">Gutter Generation</p>
